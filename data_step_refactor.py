...
# ):
#     spt_dict = {
#         stn: dists[dists < float("inf")] for stn, dists in spt_dict.items()
#     }
#
#     return link_spatial_data(ts_dict, label_col, num_spt, spt_dict)
#
#
...
#
#     ts_dict_keys = np.array(list(ts_dict.keys()))
#     spt_dict = {
#         stn: dists[(dists <= max_dist_th) & (dists.index.isin(ts_dict_keys))]
